        ...
        <div className="chat-container">
          {messages.map((message, index) => (
            message.role === 'user' ? (
              ...
              <div key={index} className={message.isHighRisk ? 'p-4 bg-red-50 border-l-4 border-red-500 rounded-lg mb-4' : ''}>
                <AIBubble message={message.content} />
                {message.isHighRisk && (
                  <p className="text-sm text-red-700 mt-2 font-medium max-w-[650px]">
                    ⚠️ If you're experiencing a crisis, please reach out to a professional immediately.
                  </p>
                )}
              </div>
            )
